...
from utils.code_generation import SharedFunctionStore
...
def __generate_initialization_codes(graph):
    ...
    initialization_code.extend(["from pyspark.sql.functions import col, from_json, to_json, window, udf, lag, date_add, explode, lit, concat, unix_timestamp, sum, abs", os.linesep])
