...
mmi_value_0_node6 = ["Sex", "Embarked", "Survived"]
mmi_value_1_node6 = ["indexedSex", "indexedEmbarked", "indexedSurvived"]
stages_node6 = []
for i in range(len(mmi_value_0_node6)):
	stages_node6.append(StringIndexer(inputCol=mmi_value_0_node6[i], outputCol=mmi_value_1_node6[i], handleInvalid="error", stringOrderType="frequencyDesc"))

mmi_value_0_node7 = ["indexedSex", "indexedEmbarked"]
mmi_value_1_node7 = ['sexVec', 'embarkedVec']
stages_node7 = []
for i in range(len(mmi_value_0_node7)):
	stages_node7.append(OneHotEncoder(inputCol=mmi_value_0_node7[i], outputCol=mmi_value_1_node7[i]))
