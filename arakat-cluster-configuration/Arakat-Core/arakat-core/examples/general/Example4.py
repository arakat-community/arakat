...
data={
    "graph":{
        ...
        "edges": {
            ...
            "node7-node10": {"type": "dataframe"},
            "node8-node9": {"type": "cv"},
            "node10-node11": {"type": "model"},
            "node3-node12": {"type": "dataframe", "portion": 1},
            "node7-node12": {"type": "model"},
            "node12-node13": {"type": "dataframe"},
            "node10-node13": {"type": "model"},
